...
export default function Hero() {
  return (
    <HeroPage className="min-h-full">
      <div className="absolute z-0 w-full h-full opacity-50 overflow-hidden">
        <video
      ...
      <div className="absolute flex items-center justify-center w-full h-full">
        <Fade bottom cascade>
          <div className="mb-24 px-4 text-center text-white md:mb-64">
            <div>
              <div className="text-shadow-sp font-special text-4xl font-medium tracking-wider uppercase md:text-5xl xl:text-6xl">
                Build Your World
              </div>
